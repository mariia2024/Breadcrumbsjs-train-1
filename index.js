...
function getDayOfWeek(dayNumber) {
  ...
  switch (dayNumber) {
    ...
    case 7:
      ...
      break;
    default:
      day = "Невірний номер дня тижня";
  }
  // Повертаємо назву дня тижня
  return day;
}

console.log("Завдання 9 ====================================");
console.log("getDayOfWeek(3)", getDayOfWeek(3)); // Виведе: "Середа"
console.log("getDayOfWeek(7)", getDayOfWeek(7)); // Виведе: "Неділя"
console.log("getDayOfWeek(9)", getDayOfWeek(9)); // Виведе: "Невірний номер дня тижня"

// Задача 10: Напишіть функцію getMonthName, яка приймає номер місяця monthNumber (1-12) і повертає рядок, що відповідає цьому місяцю.
// Використовуйте конструкцію switch case для визначення місяця за його номером.
...
function getVariableType(variable) {
	...
	if (typeof variable === "number") {
		return variable ? "Це число" : "Це інший тип";
	}

	if (typeof variable === "string") {
		return variable ? "Це рядок" : "Це інший тип";
	}

	if (typeof variable === "boolean") {
		return variable ? "Це булеве значення" : "Це інший тип";
	}
...
// Задача 11: Напишіть рекурсивну функцію, яка обчислює факторіал числа.
...
// Створюємо змінну squareArea, якій присвоюємо результат виконання функції memoizedArea
...
// Створюємо змінну createCompose, якій присвоюємо результат виконання функції compose з аргументами increment та double
