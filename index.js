...
// Ваша функція isEvenNumber перевіряє, чи є задане число парним,
// 	використовуючи оператор залишку від ділення(%).
// 	Якщо залишок від ділення числа на 2 дорівнює нулю, то число парне,
// 	і функція повертає true.Інакше, якщо залишок не дорівнює нулю, число непарне,
...
function isPrimeNumber(num) {
  ...
  // Запускаємо цикл для змінної i від 2 до Math.sqrt(num)
